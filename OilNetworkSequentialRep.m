%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This code implements the sequential estimation analysis in
...
nsimu     = 1000;          % Gibbs sampler, number of Simulation
...
%%%% data price and economic activity
figure(400)
